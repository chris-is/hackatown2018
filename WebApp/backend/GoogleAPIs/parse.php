<?php 
  ...
  try{
    ...
    if($d<$radius){
      ...
      $id2=0;
      $stmt->execute([$id, $id2, $message, $geolocation, $date]);
      
      //Call python to check keywords
      //$command = 'export GOOGLE_APPLICATION_CREDENTIALS=~/public_html/GoogleAPIs/OAuth/Hackatown2018-3dd19556fe93.json';
      //$export = `$command`;
      //echo "before python";
